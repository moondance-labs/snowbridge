...
import {ParaID, Command, ChannelID} from "../v1/Types.sol";
import {IGatewayBase} from "./IGatewayBase.sol";

interface IOGateway is IGatewayBase {
    ...
    function sendRewards(ChannelID channelID, bytes calldata data) external;
